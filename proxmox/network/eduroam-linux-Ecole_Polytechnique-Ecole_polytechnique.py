...
Messages.wrongUsernameFormat = "Erreur : votre nom d'utilisateur doit " \
    "être de la forme 'xxx@institutionID', par exemple  'john@example.net' " \
    "!"
...
Messages.cat_dir_exists = "Le répertoire {} existe ; certains de ses " \
    "fichiers peuvent être écrasés"
Config.instname = "Ecole Polytechnique"
Config.profilename = "Ecole polytechnique"
Config.url = "https://portail.polytechnique.edu/dsi/wifi/"
Config.email = "support@polytechnique.fr"
Config.title = "eduroam CAT"
Config.server_match = "polytechnique.fr"
...
Config.init_confirmation = "Cet installateur ne fonctionnera " \
    ...
    "{1}."
Config.user_realm = "polytechnique.fr"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:nac-wifi1.polytechnique.fr', 'DNS:nac-wifi2.polytechnique.fr']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@polytechnique.fr"
Config.tou = ""
